...
def cultural_algorithm(n, population_size = 100, time_limit_seconds = 60):
    ...
    elapsed = time.time() - start_time
    return belief['best_solution'], gen, elapsed
...
n = 8
solution, gen, time = cultural_algorithm(n,population_size= 50, time_limit_seconds=60) # one-minute limit

print(f"\nBest Solution : {solution}")
print(f"Fitness Score : {fitness(solution)}")
